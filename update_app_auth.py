...
# Make sure to import Bolt icon for the login screen if we want to use one, or just standard Lucide ones
login_screen = """
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="bg-slate-800 p-8 rounded-3xl shadow-2xl max-w-md w-full border border-slate-700 text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Workspace Login Required</h1>
...
if 'if (!user) {' not in content:
    content = content.replace("  return (\n    <div className=\"min-h-screen bg-slate-100/70", login_screen + "\n  return (\n    <div className=\"min-h-screen bg-slate-100/70")
